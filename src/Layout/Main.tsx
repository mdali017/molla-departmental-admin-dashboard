        ...
        <div className="flex items-start justify-between">
          ...
          <div className="relative hidden h-screen shadow-lg lg:block w-80">
            <div className="h-full bg-gray-700">
              ...
              <nav className="mt-6 flex flex-col justify-between h-[550px] ">
                <div>
                  <a
                    className="flex items-center justify-start w-full p-2 pl-6 my-2  border-l-4 border-purple-500 text-white"
                    href="#"
                  >
                  ...
                  <a
                    className="flex items-center justify-start w-full p-2 pl-6 my-2   border-l-4 border-transparent text-white"
                    href="#"
                  >
                    <span className="text-left">
                      <svg
                  ...
                  >
                    ...
                    <span className="mx-2 text-sm font-normal">Reports</span>
                  </a>
                ...
                <div>
                  <div className="flex items-center justify-start w-full p-2 pl-6 my-2   text-white">
                    <MdLogout />
                    <Link className="ml-2 text-white" to={"/"}>
                      Logout
                    </Link>
                  </div>
                </div>
          ...
          <div className="flex flex-col w-full md:space-y-4">
            {/*  */}
            <header className="z-40 bg-slate-400 flex items-center justify-between w-full h-16">
